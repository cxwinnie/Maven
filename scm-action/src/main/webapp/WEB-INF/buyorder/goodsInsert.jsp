...
<script type="text/javascript">
	$(function(){
			    ...
			    toolbar: [{
					...
					handler: function(){
						 parent.$('#win').window({    
						    ...
						    height:400,    
						    modal:true,
						    content:"<iframe src='${proPath}/base/goURL/goods/goodsSelect' height='100%' width='100%' frameborder='0px' ></iframe>"  
						});  
					}
			...
			onClickCell: function(index,field,value){
				...
				if(editIndex!= undefined){					
				 ...
				 /*  $(this).datagrid('endEdit', editIndex);
				  ...
				  var bodTotalPrice =$(buyPrice.target).val()*$(amount.target).val();
		...
		$('#supName').searchbox({ 
			...
			//alert(value + "," + name);
			 			parent.$('#win').window({    
						    ...
						    height:600,    
						    modal:true,
						    content:"<iframe src='${proPath}/base/goURL/supplier/supplierSelect' height='100%' width='100%' frameborder='0px' ></iframe>"  
						});  
		...
		$('#shId').combobox({    
		    url:'${proPath}/storeHouse/selectAll',    
		    valueField:'shId',    
		    textField:'shName'   
		});  
...
<form style="padding:15px;margin:0px;background:#eee;" id="ff" action="">
   请填写采购信息：<br>
 	...
 	<input type="text" id="supName" name="supName" readonly="readonly"/>
